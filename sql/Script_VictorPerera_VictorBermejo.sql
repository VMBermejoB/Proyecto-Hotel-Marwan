...
CREATE TABLE ofertaTipo(
                           idTipo TINYINT UNSIGNED NOT NULL PRIMARY KEY,
                           idOferta TINYINT UNSIGNED NOT NULL,
                           CONSTRAINT fk_ofertaOferta FOREIGN KEY (idOferta) REFERENCES oferta (idOferta) ON DELETE CASCADE ON UPDATE CASCADE,
