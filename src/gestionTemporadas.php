...
<nav class="row">
    <div class="col-1 d-flex align-items-center"><a href="consultarTemporadas.php">GTemporada</a></div>
    <div class="col-1 d-flex align-items-center"><a href="#">GTipo</a></div>
 ...
 */
                ...
                {
                    header("Location:consultarTemporas.php");
                }
